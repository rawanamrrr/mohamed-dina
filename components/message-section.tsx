    ...
    <section id="message" className="py-16 px-4 md:py-24 bg-gradient-to-b from-background to-accent/5">
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="bg-card/90 p-8 md:p-10 rounded-lg shadow-lg max-w-2xl mx-auto">
            <div className="relative">
              ...
              <div className="relative z-10">
                ...
                <p className="text-foreground text-lg md:text-xl leading-relaxed mb-6 font-handwritten">
                ...
                <div className="mt-10">
                  <p className="text-right text-foreground text-lg md:text-xl font-handwritten">
                    With love,
                  </p>
