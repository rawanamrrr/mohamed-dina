            ...
            <div className="relative z-10 text-center space-y-12">
              ...
              >
                ...
                >
                  ...
                  <span className="block">Dina</span>
                </motion.h1>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-semibold text-foreground">Mountain Rose Hotel, Tulip Hall</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
      ...
      <section id="countdown" className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-b from-background to-accent/5">
        ...
        >
          ...
          <motion.div
            ...
            className="relative"
          >
            <CountdownTimer targetDate={new Date("2026-04-24T19:00:00")} />
          </motion.div>
        </motion.div>
      </section>
                  ...
                  >
                    <div className="bg-card/80 backdrop-blur-sm border border-accent/20 rounded-3xl p-12 shadow-2xl relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        ...
                        >
                          Mountain Rose Hotel, Tulip Hall
                        </motion.h3>
                        <motion.p
                        ...
                        <p className="text-lg md:text-xl text-muted-foreground mt-6 text-center">
                          <span className="inline-flex items-center gap-2" dir="rtl">
                            ...
                            <span>برجاء الحضور من 6:30 مساء</span>
                          </span>
                        </p>
                      </div>
                    </div>
          ...
          {/* Footer */}
          <motion.footer
            className="relative py-20 text-center bg-transparent border-t border-accent/10"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
